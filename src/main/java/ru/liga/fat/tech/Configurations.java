...
import ru.liga.fat.tech.exception.AverageIndexOutException;
import ru.liga.fat.tech.exception.CurrencyRateException;
import ru.liga.fat.tech.exception.FailReadFile;
import ru.liga.fat.tech.util.FileReader;
import ru.liga.fat.tech.util.PeriodUtils;
...
import static ru.liga.fat.tech.constant.ConstantUtil.CURRENCY_MAP;
